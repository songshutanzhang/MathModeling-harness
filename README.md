...
**本项目为技术探索，无题库、论文、比赛附件、训练/评测记录、学习笔记、资料索引或模型密钥，所有使用均需遵循相关AI工具使用细则**

## 快速开始

需要 Python 3.11+ 和 Git。Windows、Linux、macOS 均支持调用核心脚本。
...
仓库自身包含完整相对引用；无需复制到某个厂商的全局 skills 目录。
...
## 致谢
本仓库基于 https://github.com/jihe520/MathModelAgent 商用请联系原作者。
